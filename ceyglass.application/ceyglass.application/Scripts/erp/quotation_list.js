var oTable_quotation_list, oTable_quotation_details;
var chart;
...
jQuery(function ($) {
    ...
    oTable_quotation_list = $('#quotation-list').dataTable({
...
$("#quotation-list tbody tr").live("click", function (e) {
    ...
    if (!$(this).hasClass('row_selected')) {
        oTable_quotation_list.$('tr.row_selected').removeClass('row_selected');
...
$('.li-quotation-det').click(function () {
    var selected_row = fnGetSelected(oTable_quotation_list);
...
function LoadDetailTable(refId) {
    ...
    oTable_quotation_details = $('#quotation-details-tab').dataTable({
...
function ViewQuotationDetails(element) {
    ...
    if (oTable_quotation_details.fnIsOpen(nTr)) {
        $(element).find('i').removeAttr('class').addClass('icon-collapse bigger-130');
        oTable_quotation_details.fnClose(nTr);
    }
    else {
        $(element).find('i').removeAttr('class').addClass('icon-collapse-top bigger-130');
        oTable_quotation_details.fnOpen(nTr, fnFormatDetails(oTable_quotation_details, nTr), 'details');
    }
}

/* Formating function for row details */
function fnFormatDetails(oTable_quotation_details, nTr) {
    var aData = oTable_quotation_details.fnGetData(nTr);
    /*get dummy data*/
